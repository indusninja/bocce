...
using BocceEngine.GameComponents;
using BocceEngine.InputSamples;
using BocceEngine.Physics;
using BocceEngine.Utilities;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;
using System;

namespace BocceEngineSample
{
    public class GameManager : Game
    {
        ...
        protected override void LoadContent()
        {
			...
			GameObject testObject1 = new GameObject(this, "Texture/circle", "Texture/cross", "Texture/OutlineBox");
			...
			PlayerObject gamePlayer = new PlayerObject(this, "Texture/circle", "Texture/cross", "Texture/OutlineBox");
